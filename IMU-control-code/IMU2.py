...
def IMUrecord(timecount, IMUSTOP=False, filename='IMU_readings.csv', ParticipantID='test'): 
    # Define the IMU 
...
#    IMUdatacollect = []
    ...
    # printing to file in CSV format, which we have to do by hand because micropython
        print(ParticipantID, timecount,",",IMUDataX,",", IMUDataY,",", IMUDataZ,",",  GyroDataX,",",  GyroDataY,",",  GyroDataZ, file=filewrite)
